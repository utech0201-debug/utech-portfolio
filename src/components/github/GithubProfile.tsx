    ...
    <section className="mx-auto max-w-7xl px-6 py-24">
      <div className="glass-card overflow-hidden p-6 sm:p-8 md:p-10">
        ...
        <div className="mt-6 flex flex-col gap-3 border-t border-white/10 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-gray-500">Explore the code, then let&apos;s build something useful.</p>
          <div className="flex flex-wrap gap-3">
            <a href="#github" className="rounded-lg border border-white/10 bg-white/[0.03] px-3.5 py-2 text-xs font-semibold text-gray-300 transition hover:border-blue-400/30 hover:bg-blue-400/10 hover:text-white">Browse repositories</a>
            <a href="#contact" className="rounded-lg bg-blue-600 px-3.5 py-2 text-xs font-semibold text-white transition hover:bg-blue-500">Get in touch</a>
          </div>
        </div>
      </div>
    </section>
